...
let dieArray = []; // Values added when die are added. Used in 

const newDiceBtn = document.getElementById('new-dice-button');
const rerollDiceBtn = document.getElementById('reroll-dice-button');
const sumDiceBtn = document.getElementById('sum-dice-button');
...
class Die {
    ...
    rollNumber() {
        let random1to6 = Math.ceil(Math.random() * 6);
