const makeDieBtn = document.getElementById('new-dice-button');
const rerollBtn = document.getElementById('reroll-dice-button');
const sumBtn = document.getElementById('sum-dice-button');
